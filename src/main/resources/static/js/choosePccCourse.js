...
layui.use(['table','form', 'layedit', 'laydate'], function(){
    ...
    form.on('select', function(data){
        ...
        table.reload('tb', {
            ...
            where: {"courseId":courseId,"courseName":courseName,"teacherName":teacherName,
                "teachingLocation":teachingLocation,"courseType":"专业必修课"},
        });
    ...
    table.render({
        elem: '#tb'
        ,url:'/newVersion/student/PCCcourseModule.json'
...
{
    let res={courseDetailId:[],courseType: "PCC"};
