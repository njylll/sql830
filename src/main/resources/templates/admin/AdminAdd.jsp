...
<div class="page-container">
	<form class="form form-horizontal" id="formAdd" action="<%=path%>/admin/adminAddSub"  method="post">

	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>工号：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" style="width: 400px;" class="input-text" value="" placeholder="" id="username" name="username">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" style="width: 400px;" class="input-text" autocomplete="off" value="" id="password" name="password">
		</div>
	</div>
